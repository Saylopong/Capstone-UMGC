...
func unlock_all(db: int):
	match db:
		1:
			for ASLSign in DataManager.DB_1.all_questions:
				ASLSign.is_unlocked = true
		2:
			for ASLSign in DataManager.DB_2.all_questions:
				ASLSign.is_unlocked = true
		3:
			for ASLSign in DataManager.DB_3.all_questions:
				ASLSign.is_unlocked = true
